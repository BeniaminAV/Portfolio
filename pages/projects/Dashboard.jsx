...
import { imageDashboard } from "@/public/assets/projectsImg";
    ...
    <div className="w-full overflow-hidden">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 rounded-xl">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            This React-based application is equipped with a comprehensive set of
            features including Theming, Tables, Charts, Calendar, Kanban and
            more. It streamlines the process of data management and
            organization, providing users with an efficient solution. The
            intuitive admin dashboard design offers an easy-to-use interface,
            allowing for quick navigation and data visualization. The use of
            various charts and graphs effectively presents information in a
            clear, visually appealing manner. The calendar function enables
            scheduling and management of appointments, while the kanban board
            provides a flexible approach to project management. This application
            offers users a powerful tool to make informed decisions and
            effectively manage tasks and operations.
          </p>
          ...
          <div className="flex items-center justify-start">
            <button
              onClick={() =>
                window.location.assign(
                  "https://beniaminav.github.io/Dashboard/"
                )
              }
            ...
            <button
              onClick={() =>
                window.location.assign(
                  "https://github.com/BeniaminAV/Dashboard"
                )
              }
