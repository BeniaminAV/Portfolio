...
import { imageTinder } from "@/public/assets/projectsImg";
    ...
    <div className="w-full overflow-hidden">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 rounded-xl">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            This Tinder-style dating app, created with React and a NodeJS
            backend, provides a modern and convenient platform for connecting
            with other singles. With its user-friendly design, browsing and
            matching with potential partners is a breeze. The integration of
            MongoClient ensures smooth data management, and the use of Cookies
            enables a secure and personalized experience for each user. The
            customizable on-boarding process and chat feature allow for seamless
            communication and meaningful connections. Whether you're looking for
            love, friendship, or just a fun time, this app is a must-have for
            ...
            <button
              onClick={() =>
                window.location.assign(
                  "https://github.com/BeniaminAV/Tinder-Clone-"
                )
              }
