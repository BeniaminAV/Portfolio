...
import { imageDisney } from "@/public/assets/projectsImg";
    ...
    <div className="w-full overflow-hidden">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 rounded-xl">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            Discover the magic of Disney with our new app, built with the latest
            technologies to bring you the ultimate user experience. Immerse
            yourself in a world of fun and excitement with React JS at its core,
            delivering lightning-fast performance and seamless navigation. Your
            data is securely stored on Firebase, giving you peace of mind.
            Styled Components bring the app to life with stunning design and
            eye-catching graphics, while Redux manages the state for a seamless
            and efficient user flow. Log in and log out with ease, and enjoy
            endless hours of Disney magic at your fingertips.
          </p>
          ...
          <div className="flex items-center justify-start">
            <button
              onClick={() =>
                window.location.assign(
                  "https://disney-clone-eta-three.vercel.app/"
                )
              }
            ...
            <button
              onClick={() =>
                window.location.assign(
                  "https://github.com/BeniaminAV/Disney-Clone"
                )
              }
