...
import { imageEmag} from "@/public/assets/projectsImg";
    ...
    <div className="w-full overflow-hidden">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 rounded-xl">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            My application, created with NextJs, is an online store that offers
            users the ability to connect through their Google account using
            NextAuth. Users can add products to their favorites or shopping
            cart, make payments with Stripe, and view their order history saved
            in Firebase. The design is crafted with TailwindCSS, providing a
          ...
          <div className="flex items-center justify-start">
            <button
              onClick={() =>
                window.location.assign(
                  "https://emag-shopping-hddtl4kfj-beniaminav.vercel.app/"
                )
              }
            ...
            <button
              onClick={() =>
                window.location.assign(
                  "https://github.com/BeniaminAV/Emag-Shopping-App"
                )
              }
